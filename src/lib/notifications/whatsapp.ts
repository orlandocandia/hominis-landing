...
// NOTE: WhatsApp auto-notification is NOT currently active (no API key configured)
// Agustina receives notifications via EMAIL instead (Resend - reliable)
 ...
 *
 * ⚠️ Currently NOT active - no API key configured
 * Notifications are handled by email (Resend) which is 100% reliable
 */
