 ...
 *   3. DoctoRed    (#doctored) — placeholder
 *   4. Premedic    (#premedic) — placeholder
 *   5. ¿Cómo funciona? (#como-funciona) — 3 pasos
 *   6. Contacto    (#contacto) — formulario con selector de empresa
 *   7. Footer      — datos de contacto + links legales
 */
