...
export default function ContactosListPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Button onClick={() => router.push('/vendedor/contactos/nuevo')} className="gap-2">
      ...
      {loading ? (
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            {!search && !statusFilter && (
              <Button onClick={() => router.push('/vendedor/contactos/nuevo')} className="mt-4 gap-2">
            ...
            <Card key={c.id} className="hover:shadow-md transition-shadow">
              <CardContent className="flex items-center justify-between p-4">
                ...
                <Button size="sm" variant="ghost" asChild className="flex-shrink-0">
                  <Link href={`/vendedor/contactos/${c.id}`}>Ver</Link>
                </Button>
              </CardContent>
            </Card>
          ))}
