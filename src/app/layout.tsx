...
// Google Analytics 4 — solo se carga si NEXT_PUBLIC_GA_MEASUREMENT_ID está configurada.
  ...
  return (
    <html lang="es" suppressHydrationWarning>
      ...
      >
        ...
        {/* Google Analytics 4 — solo carga si el ID está configurado en Vercel env vars */}
        {GA_ID && (
          <>
            <Script
