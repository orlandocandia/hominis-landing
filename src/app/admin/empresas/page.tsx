...
// /admin/empresas — CRUD completo de empresas.
import { useState, useEffect, useCallback } from 'react';
import {
  Plus, Edit3, Trash2, RefreshCw, Loader2, Building2, Mail, Phone, MapPin, X,
} from 'lucide-react';
...
const EMPTY_FORM = {
  nombre: '', email: '', telefono: '', direccion: '', activo: true,
};
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex gap-2">
          <Button variant="outline" onClick={fetchEmpresas} className="gap-2">
          ...
          <CardContent className="p-6">
            ...
            <form onSubmit={handleSubmit} className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="flex items-center gap-2 sm:col-span-2">
                ...
                />
                <Label htmlFor="activo" className="cursor-pointer">Empresa activa</Label>
              </div>
