...
const STATUS_COLORS: Record<string, string> = {
  ...
  EN_CONTACTO: 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400',
  REUNION: 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400',
  PRESUPUESTO: 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400',
...
export default function LeadsPage() {
  ...
  const [filtros, setFiltros] = useState({
    status: '', segmento: '', search: '', fechaDesde: '', fechaHasta: '',
  });
  ...
  const handleLimpiarFiltros = () => {
    setFiltros({ status: '', segmento: '', search: '', fechaDesde: '', fechaHasta: '' });
  };
          ...
          <div className="flex flex-wrap gap-2">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 border border-input rounded-lg bg-background text-foreground text-sm focus:ring-2 focus:ring-primary focus:outline-none"
              />
            </div>
...
// COMPONENTE LEAD ROW
// ============================================
function LeadRow({ lead, isSelected, onSelect, onAction, onDelete }: any) {
      ...
      <tr className="hover:bg-muted/30 transition">
        ...
        <td className="px-4 py-3 text-right">
          <div className="flex items-center justify-end gap-1">
            ...
            <button onClick={handleExport} className="p-1.5 hover:bg-muted rounded-lg transition" title="Exportar JSON" disabled={loading}>
              <Download className="w-4 h-4 text-muted-foreground" />
            </button>
            <button onClick={handlePrint} className="p-1.5 hover:bg-muted rounded-lg transition" title="Imprimir" disabled={loading}>
