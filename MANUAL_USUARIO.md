...
Cada vez que se recibe un nuevo lead desde el formulario, el sistema envía automáticamente un email a asesoradesaludagustinacandia@gmail.com con el nombre, email, teléfono y mensaje del cliente. Este email incluye un enlace directo al panel de administración para gestionar el lead.
